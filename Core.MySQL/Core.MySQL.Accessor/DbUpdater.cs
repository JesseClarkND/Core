...
namespace Core.MySQL.Accessor
{
    public class DbUpdater
    {
        ...
        private void ExecuteScalarCommand(MySqlCommand cmd)
        {
            while (true)
            {
                try
        ...
        private void BindFieldList(MySqlCommand cmd)
        {
            foreach (DbField f in _fields)
            {
                object val = f.Value;
                ...
                //parameter.Value = val;
                //cmd.Parameters.Add(parameter);
                cmd.Parameters.AddWithValue("@" + f.Name, val);
            }
        }

        public void BindParameterList(MySqlCommand cmd)
        {
